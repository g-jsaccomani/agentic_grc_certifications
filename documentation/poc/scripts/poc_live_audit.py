...
def main():
    ...
    for idx, finding in enumerate(res["findings"], 1):
        ...
        status_tag = "[PASS]" if status == "COMPLIANT" else "[FAIL]"
        print(f"\n[{idx}] {status_tag} Status: {status} | Control: {ctrl}")
    ...
    print("\n" + "=" * 70)
    print(" SYNTHESIZED ZERO-TRUST REMEDIATION PLAYBOOKS")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print(" [SUCCESS] POC AUDIT COMPLETE: Environment evaluated against ISO 27001/27002!")
    print("=" * 70)
