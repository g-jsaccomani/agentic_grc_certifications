...
| **[`HOW_TO.md`](./HOW_TO.md)** | **Step-by-Step POC Demo Runbook**: Zero-to-Hero presentation script with exact click-by-click instructions, demo narrative, talk tracks, objection handling, and live telemetry checks. | Solution Architects, Sales Engineers, Technical Presenters |
